...
public class Pathfinding : MonoBehaviour {
    ...
    public Player player;//Starting position to pathfind to
    ...
    {
        FindPath(transform.position, player.transform.position);//Find a path to the goal
    }
    ...
    public List<Node> retrieveAgentPath() {
    ...
    //    List<Node> path = GridReference.FinalPath;
